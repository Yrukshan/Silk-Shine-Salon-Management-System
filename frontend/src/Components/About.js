        ...
        >
          <Box textAlign="center" maxW="800px" mx="auto" mt={20}>
            ...
            <Text className="hero-description" fontSize="lg" mb={8} maxW="500px" mx="auto" color="rgba(255, 255, 255, 0.9)">
              At Silk & Shine, we believe beauty is an experience. Our mission is to provide top-quality salon and spa treatments 
              in a luxurious environment, helping you look and feel your absolute best.
            </Text>
